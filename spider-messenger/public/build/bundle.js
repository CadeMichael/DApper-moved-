    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td0, "class", "svelte-9fejjv");
    			add_location(td0, file, 14, 10, 176);
    			attr_dev(input0, "class", "svelte-9fejjv");
    			add_location(input0, file, 15, 15, 215);
    			attr_dev(td1, "class", "svelte-9fejjv");
    			add_location(td1, file, 15, 10, 210);
    			attr_dev(tr0, "class", "svelte-9fejjv");
    			add_location(tr0, file, 13, 8, 161);
    			add_location(b1, file, 18, 15, 271);
    			attr_dev(td2, "class", "svelte-9fejjv");
    			add_location(td2, file, 18, 10, 266);
    			attr_dev(input1, "class", "svelte-9fejjv");
    			add_location(input1, file, 19, 15, 309);
    			attr_dev(td3, "class", "svelte-9fejjv");
    			add_location(td3, file, 19, 10, 304);
    			attr_dev(tr1, "class", "svelte-9fejjv");
    			add_location(tr1, file, 17, 8, 251);
    			attr_dev(table, "class", "svelte-9fejjv");
    			add_location(table, file, 12, 6, 145);
    			attr_dev(form, "class", "svelte-9fejjv");
    			add_location(form, file, 11, 4, 132);
    			attr_dev(dev, "class", "content svelte-9fejjv");
    			add_location(dev, file, 5, 2, 31);
    			attr_dev(main, "class", "svelte-9fejjv");
